      ...
      <form>
        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50">
          <div className="flex items-center justify-between px-3 py-2 border-b">
            ...
            <button style={baseGlassStyle} type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-dark rounded-lg">
              Publish post
            </button>
          ...
          <div className="px-4 py-2 bg-white rounded-b-lg">
            ...
            <textarea id="editor" rows={6} className="block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0 " placeholder="Write an article..." required></textarea>
          </div>
        </div>
